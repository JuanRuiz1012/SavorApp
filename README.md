...
```
cd existing_repo
git remote add origin https://gitlab.com/juan.ruiz.lopez/savorapp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/juan.ruiz.lopez/savorapp/-/settings/integrations)
